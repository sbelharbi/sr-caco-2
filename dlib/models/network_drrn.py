...
# Credit: https://github.com/Lornatang/DRRN-PyTorch
...
# Paper: "Image Super-Resolution via Deep Recursive Residual Network", CVPR,
# 2017, Ying Tai, Jian Yang, Xiaoming Liu.
...
class DRRN(nn.Module):
    def __init__(self,
        ...
        self.conv1 = nn.Sequential(
            nn.ReLU(True),
            nn.Conv2d(in_chans, 128, (3, 3), (1, 1), (1, 1), bias=False)
        )

        # Features trunk blocks
        self.trunk = RecursiveBlock(128, num_residual_units)

        # Output layer
        self.conv2 = nn.Sequential(
            nn.ReLU(True),
            nn.Conv2d(128, in_chans, (3, 3), (1, 1), (1, 1), bias=False)
        )
...
if __name__ == '__main__':
    ...
    b = 32
    in_chans = 3
    num_residual_units = 25

    model = DRRN(in_chans=in_chans,
                 upscale=upscale,
